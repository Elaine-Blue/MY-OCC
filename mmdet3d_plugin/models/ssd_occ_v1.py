...
class SSDOCCV1(MVXTwoStageDetector):
    def __init__(self,
                 use_grid_mask=True,
                 data_aug=None,
                 stop_prev_grad=0,
    ...
    def forward_train(self,
        ...
        outs = self.pts_bbox_head(img_feats, img_metas, gt_bboxes_3d, gt_labels_3d)
        loss_inputs = [voxel_semantics, mask_camera, boundary_labels, outs]
